   ...
   <div class="card-body">
      ...
      <div class="card m-2">
         ...
         <script>
            function requestGet() {
            	//아래 애들은 다~ 문자열로 얻어짐!
               const param1 = document.form1.param1.value; //name으로 만 접근함!
               const param2 = document.querySelector("#param2").value; //id로 접근함!
               const param3 = $("#param3").val(); //제이쿼리로 id 접근(얘는 제이쿼리 객체임!)
               const param4 = $("#form1 input[name=param4]:checked").val(); //제이쿼리로 속성으로 접근
