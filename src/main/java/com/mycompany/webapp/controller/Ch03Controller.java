...
public class Ch03Controller {
	...
	@GetMapping("/method4")
	public String method4(@RequestParam(defaultValue = "문자열") String param1,@RequestParam(defaultValue = "0") int param2, @RequestParam(defaultValue = "0.0") double param3, @RequestParam(defaultValue = "false") boolean param4) {
		log.info(param1);
		log.info(param2);
		log.info(param3);
		log.info(param4);
	...
	@GetMapping("/method5")
	public String method5(@RequestParam(defaultValue = "문자열") String param1,@RequestParam(defaultValue = "0") int param2, @RequestParam(defaultValue = "0.0") double param3, @RequestParam(defaultValue = "false") boolean param4) {
		log.info(param1);
		log.info(param2);
		log.info(param3);
		log.info(param4);
